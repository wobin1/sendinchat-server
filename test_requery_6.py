...
async def check():
    ...
    payloads = [
        {'name': 'snake_case_account', 'data': {'transactionId': txn_id, 'amount': 4, 'transactionType': 'CREDIT', 'transactionDate': '2026-03-28', 'account_no': '1100078367'}},
        {'name': 'reference_instead_of_id', 'data': {'reference': txn_id, 'amount': 4, 'transactionType': 'CREDIT', 'transactionDate': '2026-03-28', 'accountNo': '1100078367'}},
        {'name': 'Amount_string_2dec', 'data': {'transactionId': txn_id, 'Amount': '4.00', 'transactionType': 'CREDIT', 'transactionDate': '2026-03-28', 'accountNo': '1100078367'}}
    ]
    for p in payloads:
