...
async def check():
    ...
    txn_id = 'TXN20260328012507875652-credit' # The one from logs
    payloads = [
        {'name': 'lowercase_amount', 'data': {'transactionId': txn_id, 'amount': 4, 'transactionType': 'CREDIT', 'transactionDate': '2026-03-28', 'accountNo': '1100078367'}},
        {'name': 'capital_Amount', 'data': {'transactionId': txn_id, 'Amount': 4, 'transactionType': 'CREDIT', 'transactionDate': '2026-03-28', 'accountNo': '1100078367'}}
    ]
    for p in payloads:
